...
@register_env('ant-bullet-rand')
class AntBulletRandEnv(AntBulletEnv):

    def __init__(self, task={}, n_tasks=2, randomize_tasks=True):
        super(AntBulletRandEnv, self).__init__()
        self.reset()
    ...
    # For debugging
    def check_task(self):
        dyn_info = self._p.getDynamicsInfo(self.robot_body.bodies[0], -1)
        print("Body params: mass={} and latF={}".format(dyn_info[0], dyn_info[1]))
